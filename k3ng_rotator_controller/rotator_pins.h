...
#define button_cw A2 //A1             // normally open button to ground for manual CW rotation
#define button_ccw A3 //A2            // normally open button to ground for manual CCW rotation
#define serial_led 0 //0             // LED blinks when command is received on serial port (set to 0 to disable)
